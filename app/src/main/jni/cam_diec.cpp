...
int cam_diec::load(AAssetManager *mgr, int _target_size, const float *_norm_vals, bool use_gpu) {
    yolo.clear();
...
int cam_diec::detect(const cv::Mat &rgb, std::vector<Object> &objects, float prob_threshold,
                     float nms_threshold) {
    int width = rgb.cols;
    int height = rgb.rows;
...
int cam_diec::draw(cv::Mat &rgb, const std::vector<Object> &objects) {
    static const char *class_names[] = {"cam_on", "hen_gap_lai", "khoe", "khong_thich",
                                        "rat_vui_duoc_gap_ban", "so", "tam_biet", "thich",
                                        "xin_chao", "xin_loi", "biet", "anh_trai", "chi_gai",
                                        "hieu", "me", "nha", "nho", "to_mo", "yeu", "chu_a",
                                        "chu_b", "chu_c", "chu_d", "chu_e", "chu_g", "chu_h",
                                        "chu_i", "chu_k", "chu_l", "chu_m", "chu_n", "chu_o",
                                        "chu_p", "chu_q", "chu_r", "chu_s", "chu_t", "chu_u",
                                        "chu_v", "chu_x", "chu_y", "dau_cham", "dau_hoi",
                                        "dau_huyen", "dau_sac", "dau_nga", "dau_mu", "dau_mu_nguoc",
                                        "cham_soc", "con_nguoi", "cong_cong", "cong_viec",
                                        "giong_nhau", "giuong", "giup_do", "hop_tac", "kham_benh",
                                        "khat_nuoc", "khen", "lang_nghe", "le_phep", "nan_ni"
    };
