...
int SCRFD_DEAF::load(const char *modeltype, bool use_gpu) {
    scrfd_deaf.clear();
...
int SCRFD_DEAF::load(AAssetManager *mgr, const char *modeltype, bool use_gpu) {
    scrfd_deaf.clear();
    ...
    scrfd_deaf.load_param(mgr, parampath);
    scrfd_deaf.load_model(mgr, modelpath);
