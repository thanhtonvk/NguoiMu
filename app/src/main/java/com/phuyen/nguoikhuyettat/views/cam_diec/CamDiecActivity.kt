...
import com.phuyen.nguoikhuyettat.databinding.ActivityCamDiecBinding
import java.util.Locale

class CamDiecActivity : AppCompatActivity(), SurfaceHolder.Callback {
    var binding: ActivityCamDiecBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCamDiecBinding.inflate(layoutInflater)
        ...
        get() {
            Thread {
                while (true) {
                    ...
                    if (!dataDeaf.isEmpty()) {
                        val deafScore = dataDeaf
                        val deaf = getDeaf(deafScore)
                        val cuChi = getSource("emotion", deaf)
